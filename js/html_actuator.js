...
HTMLActuator.prototype.scoreTweetButton = function () {
  ...
  tweet.setAttribute("data-url", "https://tristantwo.github.io/Clash-Royale-2048/");
  tweet.setAttribute("data-counturl", "https://tristantwo.github.io/Clash-Royale-2048/");
  tweet.textContent = "Tweet";

  var text = Localize("tweet1") + Localize( this.score ).toUpperCase() + '", ' + this.points + " " + Localize("tweet2");
